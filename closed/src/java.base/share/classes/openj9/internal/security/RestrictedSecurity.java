...
public final class RestrictedSecurity {
    ...
    private static final class ProfileParser {
        ...
        private void parseProvider(String providerInfo, int providerPos, boolean update, boolean isFIPS140_2) {
            if (debug != null) {
                debug.println("\t\tLoading provider in position " + providerPos);
            }

            checkProviderFormat(providerInfo, update, isFIPS140_2);
        ...
        private void initProviders(String profileID, List<String> allInfo) {
            ...
            for (int pNum = 1;; ++pNum) {
                ...
                boolean isFIPS140_2 = isFIPS1402Profile(profileID);
                parseProvider(providerInfo, pNum, false, isFIPS140_2);
            }
        ...
        private void updateProviders(String profileExtensionId, List<String> allInfo) {
            ...
            for (int i = 1; i <= numOfExistingProviders; i++) {
                ...
                if (providerInfo != null) {
                    ...
                    if (!providerInfo.isBlank()) {
                        ...
                        boolean isFIPS140_2 = isFIPS1402Profile(profileExtensionId);
                        parseProvider(providerInfo, i, true, isFIPS140_2);
                    } else {
            ...
            for (int i = numOfExistingProviders + 1;; i++) {
                ...
                boolean isFIPS140_2 = isFIPS1402Profile(profileExtensionId);
                parseProvider(providerInfo, i, false, isFIPS140_2);
            }
        }
        ...
        private static void checkProviderFormat(String providerInfo, boolean update, boolean isFIPS140_2) {
